      ...
      <div className="relative max-w-[1400px] mx-auto px-6">
        ...
        >
          ...
          <div className="md:col-span-3 xl:col-span-1">
            <img src="/assets/images/tigrid-logo.png" className="h-7 mb-6" />
            ...
            "
            >
              We believe in being remarkable every day. Our commitment to
              excellence drives us to deliver innovative IT solutions that
              transform businesses. Let's work together to achieve remarkable
              results.
            </p>

            <h3 className="text-[15px] tracking-[0.18em] mb-4">Newsletter</h3>
